...
任务卸载算法的设计方面，自适应算法、契约理论建模、深度强化学习、能效资源分配算法等多种方法呼应着不同的优化目标，如最小化延迟、最大化计算和通信速率以及节能减排。
...
**任务卸载算法设计:**
自适应算法[^c5][^c8]专注于最小化平均响应时间。契约理论建模[^c9]提出了一种目标是最小化网络延迟的算法。深度强化学习[^c10]追求最大化计算和通信速率。能效资源分配算法[^c11]和最小化能耗和延迟的加权和算法[^c12]也在讨论中。
