...
```dataviewjs
let reg=/[\u4e00-\u9fa5]/
//let nofold = '!"0. Attach/0.1 Template" and !"99-Attachment" and !"50-Inbox"'
let nofold = '"00-Tips"'
...
## 随机显示指定文件夹的嵌入文件
```dataviewjs
let nofold = '!"0. Attach/0.1 Template" and !"99-Attachment" and !"50-Inbox" and !#moc'
let fold = '!"0. Attach/0.1 Template" and !"99-Attachment" and !"50-Inbox" and !#moc'
let files = dv.pages(nofold).file
const random = Math.floor(Math.random() * (files.length - 1))
const randomNote = files[random]
...
## 随机显示文档中的内链图片
```dataviewjs
let nofold = '!"0. Attach/0.1 Template" and !"99-Attachment" and !"10-Help" and !"50-Inbox"' //排除文件夹
