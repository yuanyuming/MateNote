...
Nodes:
 - "TABLE file.name, \"([\", \"])\", \"yellow\" FROM  #book where !contains(file.folder, \"0. Attach/0.1 Template\")"
Links:
 - "TABLE WITHOUT ID status, file.name, \"\" FROM #book WHERE status FLATTEN status where !contains(file.folder, \"0. Attach/0.1 Template\")"
Styles:
